...
var x = localStorage.getItem('x'); //读取key为x的本地字符串

var xObject = JSON.parse(x); //把字符串x转化为对象
...
var simplifyUrl = function simplifyUrl(url) {
  return url.replace('https://', '').replace('http://', '').replace('www.', '').replace(/\/.*/, ''); //删除 / 开头的内容，直到结尾
};
...
//# sourceMappingURL=main.4fa7c677.js.map